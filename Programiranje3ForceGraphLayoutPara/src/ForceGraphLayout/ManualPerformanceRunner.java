...
public class ManualPerformanceRunner {
    ...
    private static boolean runPerformanceTest(int nodeCount, int edgeCount, int iterations, int width, int height, String testName) throws InterruptedException {
        ...
        FRAlgorithmParalel alg = new FRAlgorithmParalel(graph, iterations, width, height, 40,true);
    ...
    public static void main(String[] args) throws InterruptedException {
        try {
            ...
            runPerformanceTest(1000000,1000000,10000,40000,3680,"FullPerformanceTest");

            runPerformanceTest(10000000,10000000,100000,40000,3680,"FullPerformanceTest");
